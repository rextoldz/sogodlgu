...
@section('content')
<!-- chartist CSS -->
    <link href="{{ asset('adminfiles/assets/plugins/chartist-js/dist/chartist.min.css') }}" rel="stylesheet">
    <link href="{{ asset('adminfiles/assets/plugins/chartist-js/dist/chartist-init.css') }}" rel="stylesheet">
    <link href="{{ asset('adminfiles/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css') }}" rel="stylesheet">
...
<div class="row">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <!-- Column -->
        <div class="card">
            <img class="card-img-top" src="{{ asset('adminfiles/assets/images/background/profile-bg.jpg') }}" alt="Card image cap">
            <div class="card-block little-profile text-center">
                <div class="pro-img"><img src="{{ asset('adminfiles/assets/images/users/4.jpg') }}" alt="user" /></div>
            ...
            <div class="card-block">
                <div class="message-box contact-box">
                    ...
                    <div class="message-widget contact-widget">
                        <!-- Message -->
                        <a href="#">
                            <div class="user-img"> <img src="{{ asset('adminfiles/assets/images//users/1.jpg') }}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
...
<!-- chartist chart -->
    <script src="{{ asset('adminfiles/assets/plugins/chartist-js/dist/chartist.min.js') }}"></script>
    <script src="{{ asset('adminfiles/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js') }}"></script>
    <script src="{{ asset('adminfiles/assets/plugins/d3/d3.min.js') }}"></script>
    <script src="{{ asset('adminfiles/assets/plugins/c3-master/c3.min.js') }}"></script>
 <!-- Chart JS -->
    <script src="{{ asset('adminfiles/js/dashboard1.js') }}"></script>
