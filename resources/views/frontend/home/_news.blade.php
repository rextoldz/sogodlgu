<style type="text/css">
	.card-title2{background-color: #426263;padding: 1px 0px 1px -1px;font-size: 0.9em;}
</style>
...
<div class="row">
	<div class="col-sm-12 col-md-6 col-lg-6  py-0 pl-3 pr-1 featcard">
	   <div id="featured" class="carousel slide1 carousel-fade" data-ride="carousel">
 		 <div class="carousel-inner">
		<div class="carousel-item active">			  
		<div class="card bg-dark text-white">
		    <img class="card-img img-fluid" src="{{ asset('images/news/news1.gif') }}" alt="">
	  		...
	  		<div class="card bg-dark text-white">
		        ...
		        <div class="card-img-overlay d-flex linkfeat">
		          <a href="http://gerbong.id/dpr-setujui-penambahan-anggaran-bp-batam-rp565-miliar" class="align-self-end">
		            ...
		            <h4 class="card-title2">DPR Setujui Penambahan Anggaran BP Batam Rp565 Miliar</h4>
	  		...
	  		<div class="card bg-dark text-white">
		        ...
		        <div class="card-img-overlay d-flex linkfeat">
		          <a href="http://gerbong.id/sistem-oss-resmi-diluncurkan" class="align-self-end">
		            ...
		            <p class="textfeat" style="display: none;">Gerbong.id - Menteri Koordinator Bidang Perekonomian Darmin Nasution bersama dengan para menteri dan kepala lembaga terkait meresmikan penerapan Sistem Online Single Submission (OSS). Layanan Perizinan Berusaha Terintegrasi Secara Elektronik (PBTSE), yang</p>
		          </a>
		        </div>
		      </div>
	  		</div>
	  		...
	  		<div class="card bg-dark text-white">
		        ...
		        <div class="card-img-overlay d-flex linkfeat">
		          <a href="http://gerbong.id/grab-gandeng-samsung-telkomsel-dan-erafone" class="align-self-end">
		            ...
		            <p class="textfeat" style="display: none;">:: Luncurkan Program Ponsel Cerdas untuk Pengemudi Batam - Grab menjalin kemitraan strategis dengan tiga perusahaan terkemuka di Indonesia yaitu Telkomsel, Samsung, dan Erafone terkait program kepemilikan ponsel cerdas khusus untuk</p>
		          </a>
		        </div>
		      </div>
	  		</div>
	  		...
	  		<div class="card bg-dark text-white">
		        ...
		        <div class="card-img-overlay d-flex linkfeat">
		          <a href="http://gerbong.id/paket-kebijakan-ekonomi-mempermudah-izin-investasi" class="align-self-end">
		            ...
		            <p class="textfeat" style="display: none;">Gerbong.id– Paket kebijakan ekonomi dinilai dapat memberikan kemudahan dalam pengurusan perizinan berinvestasi dan memberikan efek yang cukup signifikan kepada investor. Ketua Umum Himpunan Kawasan Industri (HKI) Sanny Iskandar menyatakan saat ini</p>
		          </a>
		        </div>
		      </div>
	  		</div>
		...
		<div class="row">
			<div class="col-6 pb-2 mg-1	">
		        ...
		        <div class="card-img-overlay d-flex">
		          <a href="http://gerbong.id/bi-atur-standarisasi-qr-code" class="align-self-end">
		        	<span class="badge">Finansial</span> 
		            <h6 class="card-title2">BI Atur Standarisasi QR Code</h6>
		          </a>
		        </div>
		      	</div>
			</div>
			<div class="col-6 pb-2 mg-2	">
		        ...
		        <div class="card-img-overlay d-flex">
		          <a href="http://gerbong.id/ptsp-bp-batam-masuk-10-terbaik-di-indonesia" class="align-self-end">
		        	<span class="badge">Industri</span> 
		            <h6 class="card-title2">PTSP BP Batam Masuk 10 Terbaik di Indonesia</h6>
		          </a>
		        </div>
		      	</div>
			</div>
			<div class="col-6 pb-2 mg-3	">
		        ...
		        <div class="card-img-overlay d-flex">
		          <a href="http://gerbong.id/review-gsp-amerika-ingin-perdagangan-saling-menguntungkan" class="align-self-end">
		        	<span class="badge">Ekspor</span> 
		            <h6 class="card-title2">Review GSP: Amerika Ingin Perdagangan Saling Menguntungkan</h6>
		          </a>
		        </div>
		      	</div>
			</div>
			<div class="col-6 pb-2 mg-4	">
		        ...
		        <div class="card-img-overlay d-flex">
		          <a href="http://gerbong.id/dpr-setujui-penambahan-anggaran-bp-batam-rp565-miliar" class="align-self-end">
		        	<span class="badge">Pertumbuhan Ekonomi</span> 
		            <h6 class="card-title2">DPR Setujui Penambahan Anggaran BP Batam Rp565 Miliar</h6>
		          </a>
		        </div>
		      	</div>
			</div>
